...
class KonsultchefTestautomatisering:
    ...
    def verify_email_and_phone_number(self):
        self.konsultchef_email_locator.click()
        expect(self.konsultchef_email_adress_locator).to_be_visible()
        self.konsultchef_telephone_locator.click()
        expect(self.konsultchef_phonenumber_locator).to_be_visible()
